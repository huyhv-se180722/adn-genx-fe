...
const NewBlog = () => {
  ...
  const handleSubmit = () => {
    ...
    const newBlog = {
      id: newId,
      title: blog.title,
      content: blog.content || "", // Đảm bảo luôn có content
      date: dateStr,
      status: "Công khai",
    ...
    <div className="min-h-screen flex bg-white">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 px-10 py-8 bg-white">
          <h2 className="text-2xl font-bold mb-6 text-[#2323a7]">VIẾT BLOG MỚI</h2>
          <div className="bg-[#f3f3f3] rounded-lg shadow p-6 max-w-3xl">
            ...
            <div className="flex items-center gap-4">
              <button
                className="bg-[#009fe3] text-white px-6 py-2 rounded font-semibold flex items-center gap-2"
