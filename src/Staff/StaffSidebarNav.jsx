...
const navItems = [
  { text: "Tổng quan", path: "/staff/dashboards", icon: "bi-house-door" },
  ...
  { text: "Hồ sơ", path: "/profile", icon: "bi-person-circle" },
];
    ...
    <nav>
      <div className="staff-header mb-4">
        <div className="d-flex align-items-center">
          ...
          <span className="badge bg-secondary mt-1">Recorder Staff</span>
        </div>
      </div>
